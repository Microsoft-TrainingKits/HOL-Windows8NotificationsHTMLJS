...
The **Sending Push Notifications using Windows Azure and the Windows Push Notification Service Hands-on Lab** is licensed under the terms of the Apache License, Version 2.0.
